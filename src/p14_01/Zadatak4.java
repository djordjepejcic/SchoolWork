...
//		gettere za sve atribute
//		samo difoltni konstuktor, i njemu se svuk postavlja na 75 i kvalitet 
//		po difoltu na 144
...
//		metodu pojacaj- koja povecava jacinu zvuka za 10. Znate da morate da 
//		vodite racuna da ne predje 100.
//		metodu smanji - koja smanjuje jacinu zvuka za 10 (da ne padne ispod nule)
//		metodu postaviKvalitet - metoda kao parametar prima brzinu interneta 
//		u megbajtima.
...
//		metodu aktivirajPrekoCelogEkranaMod -  koja postavlja rezim preko 
//		celog ekrana
//		metodu premotajUnapred - metoda koja premotava trenutno vreme videa 
//		za 10s. Vodite racuna da ne predjete duzinu videa.
//		metodu premotajUnazad - metoda vraca trenutno vreme videa za 10s. 
//		Vodite racuna da ne padnete ispod nule
...
//		34893483 Pregleda 
//
//		metodu za sherovanje videa, metoda generise i vraca link do videa 
//		tako da link izgleda:
//		https://youtu.be/v6tuOipj5mk
//		Objasnjenje v6tuOipj5mk je id videa.

		Video video_1 = new Video("vbn789%#254", "Hladno pivo - Odjava programa", 250, 25000, 1000, 300000);
		YoutubePlayer y_player = new YoutubePlayer();
		
		y_player.ucitajVideo(video_1);
		
		y_player.aktivirajPrekoCelogEkranaMod();
		y_player.pojacaj();
		y_player.pojacaj();
		y_player.pojacaj();
		y_player.smanji();
		y_player.getVideo().lajkuj();
		y_player.getVideo().lajkuj();
		y_player.getVideo().lajkuj();
		y_player.getVideo().lajkuj();
		y_player.getVideo().dislajkuj();
		y_player.getVideo().pogledaj();
		y_player.getVideo().pogledaj();
		y_player.postaviKvalitet(1);
		y_player.premotajUnapred();
		y_player.premotajUnapred();
		y_player.premotajUnazad();
		y_player.iscitaj();
		y_player.shareVideo();
